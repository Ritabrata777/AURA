                               ...
                               int32_t event_id, void *event_data)
{
    ...
    switch ((esp_mqtt_event_id_t)event_id) {
        case MQTT_EVENT_CONNECTED:
            ...
            s_is_connected = true;
            if (s_event_callback) {
                s_event_callback(MQTT_EVENT_CONNECTED, NULL, s_callback_arg);
            }
            break;
        ...
        case MQTT_EVENT_DISCONNECTED:
            ...
            if (s_event_callback) {
                s_event_callback(MQTT_EVENT_DISCONNECTED, NULL, s_callback_arg);
            }
            break;
        ...
        case MQTT_EVENT_SUBSCRIBED:
            ...
            if (s_event_callback) {
                ...
                s_event_callback(MQTT_EVENT_SUBSCRIBED, &data, s_callback_arg);
            }
            break;
        ...
        case MQTT_EVENT_UNSUBSCRIBED:
            ...
            if (s_event_callback) {
                ...
                s_event_callback(MQTT_EVENT_UNSUBSCRIBED, &data, s_callback_arg);
            }
            break;
        ...
        case MQTT_EVENT_PUBLISHED:
            ...
            if (s_event_callback) {
                mqtt_event_data_t data = {.msg_id = event->msg_id};
                s_event_callback(MQTT_EVENT_PUBLISHED, &data, s_callback_arg);
            }
            break;
        ...
        case MQTT_EVENT_DATA:
            ...
            if (s_event_callback) {
                ...
                s_event_callback(MQTT_EVENT_DATA, &data, s_callback_arg);
            }
            break;
        ...
        case MQTT_EVENT_ERROR:
            ...
            if (s_event_callback) {
                s_event_callback(MQTT_EVENT_ERROR, NULL, s_callback_arg);
            }
            break;
